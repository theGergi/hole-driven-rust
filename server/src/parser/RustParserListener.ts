...
import { HoleExpressionContext } from "./RustParser.js";
...
export class RustParserListener implements ParseTreeListener {
     ...
     * @param ctx the parse tree
     */
    enterHoleExpression_?: (ctx: HoleExpression_Context) => void;
    /**
     * Exit a parse tree produced by the `HoleExpression_`
     * labeled alternative in `RustParser.expression`.
     * @param ctx the parse tree
     */
    ...
    /**
     * Enter a parse tree produced by `RustParser.holeExpression`.
     * @param ctx the parse tree
     */
    enterHoleExpression?: (ctx: HoleExpressionContext) => void;
    /**
     * Exit a parse tree produced by `RustParser.holeExpression`.
     * @param ctx the parse tree
     */
    exitHoleExpression?: (ctx: HoleExpressionContext) => void;
    /**
